...
async function downloader_jd() {
    if (/require\(['"`]{1}.\/jdCookie.js['"`]{1}\)/.test(remoteContent))
        await download("https://gitee.com/henrytsz/jd_scripts/raw/master/jdCookie.js", "./jdCookie.js", "京东Cookies");
...
async function downloader_notify() {
    await download("https://gitee.com/henrytsz/jd_scripts/raw/master/sendNotify.js", "./sendNotify.js", "统一通知");
}

async function downloader_user_agents() {
    await download("https://gitee.com/henrytsz/jd_scripts/raw/master/USER_AGENTS.js", "./USER_AGENTS.js", "云端UA");
}
